 ...
 * {@link page_Map.OnFragmentInteractionListener} interface
...
public class page_Map extends Fragment implements OnMapReadyCallback, View.OnClickListener, GoogleMap.OnMapClickListener{
    ...
    private final LatLng mDefaultLocation=new LatLng(36.551605, 127.723915);
    private LatLng search_place;
    GoogleMap mMap;
     ...
     * @return A new instance of fragment page_Friendlist.
     */
    // TODO: Rename and change types and number of parameters
    public static page_Map newInstance() {
        page_Map fragment = new page_Map();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_page__map, container, false);
        mFusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(mContext);
        MapFragment mapFragment=(MapFragment) getActivity().getFragmentManager()
                .findFragmentById(R.id.google_map);
       mapFragment.getMapAsync(this);
        ImageButton searchplace_button=view.findViewById(R.id.placesearch_button);
        searchplace_button.setOnClickListener(this);
    ...
    public void onMapReady(GoogleMap map) {
        ...
        Log.e("permission",String.valueOf(mLocationPermissionGranted));
        updateLocationUI();
        getDeviceLocation();
